...
var mathFunctionDictionary = function (input) {
  ...
  input = input.replace(/(?:Math\.)?(E|PI|SQRT2|SQRT1_2|LN2|LN10|LOG2E|LOG10E)/g, "Math.$1");
  // Math methods ; Case insensitive
  input = input.replace(/(?:Math\.)?(abs|acos|acosh|asin|asinh|atan|atanh|atan2|cbrt|ceil|clz32|cos|cosh|exp|expm1|floor|fround|hypot|imul|log|log1p|log10|log2|max|min|pow|random|round|sign|sin|sinh|sqrt|tan|tanh|trunc)/gi, "Math.$1");
