...
(function () {
   ...
   * Polygon component
   * @param {string} name
   * @param {array} definition  Array of point objects that will make up the
   *                            polygon
   */
   ...
   * Graph component
   * @param {string} name
   * @param {string} definition String with function definition, only supports
   *                            basic operators (+,-,*,/)
   */
   ...
   */
    ...
    /**
     * Initialize the board, return in case user want to implement other
     * functionality, board will be save in JSXGen object to later instantiate
     * other objects
